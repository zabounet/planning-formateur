        ...
        <div class="header-content">
            ...
            <form class="main-form" method="post">
                <div id="part1">
                    ...
                    <input required type="date" name="date_debut" id="debut" <?php if (isset($data['date_debut'])) {
                                                                        echo 'value="' . $data['date_debut'] . '"';
                                                                    }  ?>>
                    <label for="">au</label>
                    <input required type="date" name="date_fin" id="fin" <?php if (isset($data['date_fin'])) {
